...
const DEPOIMENTOS = [
  { texto: "O atendimento foi acolhedor desde o primeiro contato. Encontrei as informações que precisava e me senti bem cuidado em cada etapa.", pessoa: "Mariana Alves, paciente ClinicaFlow" },
  { texto: "A equipe acompanhou meu caso com atenção e clareza. Ter tudo organizado tornou o cuidado muito mais tranquilo.", pessoa: "Carlos Mendes, paciente ClinicaFlow" },
];
      ...
      <section id="faq" className={styles.section}>
        <div className="cx-container">
          <div className={styles.institutionalBlock}>
            <div>
              <span className={styles.eyebrow}>Cuidado que conecta</span>
              <h2>Uma clínica feita para cuidar de pessoas</h2>
            </div>
            <div>
              <p>A ClinicaFlow une tecnologia, organização e um olhar humano para tornar cada experiência de saúde mais simples e próxima.</p>
              <p>Do primeiro contato ao acompanhamento contínuo, nossa equipe trabalha para que você encontre cuidado de qualidade em todos os momentos.</p>
              <Link href="/sobre" className={styles.textLink}>Conheça a ClinicaFlow →</Link>
            </div>
          </div>

          <div className={styles.testimonialsBlock}>
            <div className={styles.testimonialsTitle}>
              <span className={styles.eyebrow}>Experiências reais</span>
              <h2>O que nossos clientes dizem sobre nós</h2>
            </div>
            <div className={styles.testimonialsGrid}>
              {DEPOIMENTOS.map((depoimento) => (
                <blockquote key={depoimento.pessoa} className={styles.testimonial}>
